        ...
        <div class="inline-block transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:align-middle border border-gray-200 dark:border-gray-800">
            ...
            <div class="px-6 py-5 space-y-5 max-h-[70vh] overflow-y-auto custom-scrollbar">
                ...
                <div>
                    ...
                    <div id="listing-video-wrapper" class="mb-2"></div>
                    <button type="button" id="listing-add-video-btn" class="hidden text-xs font-bold text-teal-600 hover:text-teal-700 items-center gap-1.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                        Add Video
                    </button>
                    <button type="button" id="listing-remove-video-btn" class="hidden text-xs font-bold text-red-500 hover:text-red-600 items-center gap-1.5 mt-2">
