...
$modules = [
    ...
    [
        'name' => 'Ratings',
        'text' => 'Rate landlords, tenants, contractors, agents, and more — help the community make informed decisions.',
        'slug' => 'ratings',
        'live' => true,
        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.54 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.784.57-1.838-.196-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />',
    ],
    [
        'name' => 'Recommendations',
        'text' => 'Recommend who you trust to the exact community that needs them most.',
        'slug' => 'recommendations',
        'live' => true,
        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10h4.757c1.246 0 2.25 1.004 2.25 2.25 0 .594-.232 1.164-.644 1.588l-7.02 7.153a1.5 1.5 0 01-2.11 0l-7.02-7.153A2.25 2.25 0 015.243 10H10V3a1 1 0 011-1h2a1 1 0 011 1v7z" />',
    ],
];
?>
<div class="space-y-6">
