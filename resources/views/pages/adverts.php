        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6 p-6 sm:p-10">
            <div>
                ...
                <div class="flex flex-wrap items-center gap-3 mt-5">
                    ...
                    <?php endif; ?>
                    <?php if (!$isLoggedIn): ?>
                        <a href="<?= $baseUrl ?>signup?redirect=adverts" data-partial class="inline-flex items-center px-6 py-2.5 border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 font-bold text-sm rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors">
                            Register Now
                        </a>
                    <?php endif; ?>
                </div>
