<?php
// /resources/views/layouts/swap-app.php
 ...
 * hosted here as its own project (see resources/views/pages/swap.php).
 */
?>
<!DOCTYPE html>
...
<body class="font-sans antialiased h-full overflow-x-hidden text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-950"
    ...
    <?php include __DIR__ . '/../partials/swap-sidebar.php'; ?>
    ...
    <div
        ...
        <?php include __DIR__ . '/../partials/swap-header.php'; ?>
