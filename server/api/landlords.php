<?php
// /server/api/landlords.php

declare(strict_types=1);

use Src\Controller\LandlordsController;
...
try {
    $controller = new LandlordsController();
    ...
    if ($method === 'POST') {
        ...
        if (($isDelete || $isUpdate) && !$userId) {
            json_response(['success' => false, 'messages' => ['Authentication required to modify landlords']], 401);
            exit;
        }
