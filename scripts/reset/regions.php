...
function resetRegionsTable(): array
{
    ...
    try {
        ...
        $legacyData = [
            ...
            [1, 'Southern Nations Peoples Region', 70],
            [2, 'Somali Region', 70],
            [3, 'Amhara Region', 70],
            [4, 'Tigray Region', 70],
            [5, 'Oromia Region', 70],
            ...
            [2253, 'Jilin', 45],
            [2254, 'Shanxi', 45],
            [2255, 'Taiwan Province, Peoples Republic of China', 45],
            [2256, 'Jiangxi', 45],
            [2257, 'Beijing', 45],
            [2258, 'Hunan', 45],
            [2259, 'Henan', 45],
            ...
            [3023, 'Mohales Hoek District', 122],
            [3024, 'Mokhotlong District', 122],
            [3025, 'Qachas Nek District', 122],
            ...
            [4865, 'Saint Georges Municipality', 25],
            [4866, 'Saint Georges Parish', 25],
            [4867, 'Sandys Parish', 25],
            [4868, 'Smiths Parish,', 25],
            ...
            [4998, 'Scilly Cay', 8],
            [4999, 'The Valley', 8],
            [5000, 'Prickly Pear Cays', 8],
            [5001, 'East Antarctica', 9],
            [5002, 'West Antarctica', 9],
            [5003, 'Cudarebe', 13],
            [5004, 'Oranjested', 13],
            [5005, 'Santa Cruz', 13],
            [5006, 'Sabaneta', 13],
            [5007, 'Barcadera', 13],
            [5008, 'Sint Nicolaas', 13],
            [5009, 'Slakhallet', 30],
            [5010, 'Kraterisen', 30],
            [5011, 'Skarven', 30],
            [5012, 'Larsoya', 30],
            [5013, 'Randibreen', 30],
            [5014, 'Aaagaardbreen', 30],
            [5015, 'Posadowskybreen', 30],
            [5016, 'Engelbrechtbreen', 30],
            [5017, 'Nyroysa Scree', 30],
            [5018, 'Horntvedtbreen', 30],
            [5019, 'Camp Justice', 32],
            [5020, 'Diego Garcia', 32],
            [5021, 'Peros Banhos', 32],
            [5022, 'Egmont Islands', 32],
            [5023, 'Nelson Island', 32],
            [5024, 'Salomon Islands', 32],
            [5025, 'George Town', 41],
            [5026, 'Old man bay', 41],
            [5027, 'Pedro', 41],
            [5028, 'Prospect Park', 41],
            [5029, 'Coral gables', 41],
            [5030, 'Flying Fish Cove', 46],
            [5031, 'West Island', 47],
            [5032, 'Avarua', 52],
            [5033, 'Penrhyn', 52],
            [5034, 'Rakahanga', 52],
            ...
            [5038, 'Suouroy', 72],
            [5039, 'Cayenne', 76],
            [5040, 'Saint Laurent du Maroni', 76],
            [5041, 'the Society Islands archipelago', 77],
            [5042, 'the Tuamotu Archipelago', 77],
            [5043, 'the Gambier Islands', 77],
            [5044, 'the Marquesas Islands', 77],
            [5045, 'the Austral Islands', 77],
            [5046, 'Adélie Land', 78],
            [5047, 'Crozet Islands', 78],
            [5048, 'Kerguelen Islands', 78],
            [5049, 'Saint Pierre', 78],
            [5050, 'Réunion', 78],
            [5051, 'Gibraltar', 84],
            [5052, 'Westside', 84],
            [5053, 'The Rock', 84],
            ...
            [5057, 'Maniitsoq', 86],
            [5058, 'Aasiaat', 86],
            [5059, 'Grande Terre', 88],
            [5060, 'Basse Terre', 88],
            [5061, 'Hagåtña', 89],
            [5062, 'Dededo', 89],
            [5063, 'Saint Peter Port', 91],
            [5064, 'Saint Anne', 91],
            [5065, 'Heard Island and McDonald Islands', 96],
            [5066, 'Saint Helier', 110],
            [5067, 'Trinity', 110],
            [5068, 'Grouville', 110],
            [5069, 'Nossa Senhora de Fátimar', 128],
            [5070, 'Santo António', 128],
            [5071, 'Cotai', 128],
            [5072, 'Douglas', 136],
            [5073, 'Le Marin', 138],
            [5074, 'Fort de France', 138],
            [5075, 'Saint Pierre', 138],
            [5076, 'La Trinite', 138],
            [5077, 'Kani Keli', 141],
            [5078, 'Bandrele', 141],
            [5079, 'Plymouth', 148],
            ...
            [5102, 'Nablus', 169],
            [5103, 'Khan Yunis', 169],
            [5104, 'East Jerusalem', 169],
            [5105, 'Adamstown', 175],
            [5106, 'Ducie Island', 175],
            [5107, 'Henderson Island', 175],
            [5108, 'San Juan', 178],
            [5109, 'Saint Paul', 180],
            [5110, 'Le Port', 180],
            [5111, 'Saint Denis', 180],
            [5112, 'Saint Benoit', 180],
            [5113, 'Saint Pierre', 180],
            [5114, 'Le Tampon', 180],
            [5115, 'Jamestown', 184],
            [5116, 'Blue Hill', 184],
            [5117, 'Longwood', 184],
            [5118, 'Sandy Bay', 184],
            [5119, 'Saint Paul', 184],
            [5120, 'Saint-Pierre', 187],
            [5121, 'Miquelon', 187],
            [5122, 'Gustavia', 189],
            [5123, 'Lorient', 189],
            [5124, 'Grand Fond', 189],
            [5125, 'Longyearbyen', 211],
            [5126, 'Spitsbergen', 211],
            [5127, 'Barentsoya', 211],
            [5128, 'Edgeoya', 211],
            [5129, 'Nordaustlandet', 211],
            [5130, 'Atafu', 221],
            [5131, 'Nukunonu', 221],
            [5132, 'Fakaofo', 221],
            [5133, 'King Edward Point', 205],
            [5134, 'Marigot', 190],
            [5135, 'Cockburn Town', 227],
            [5136, 'Balfour Town', 227],
            [5137, 'Jackson Ville', 227],
            [5138, 'Lorimers', 227],
            [5139, 'Bambarra', 227],
            [5140, 'Marigot', 190],
            [5141, 'Midway Atoll', 234],
            [5142, 'Wake Island', 234],
            [5143, 'Kingman Reef', 234],
            [5144, 'Jarvis Island', 234],
            [5145, 'Baker Island', 234],
            [5146, 'Vatican City', 238],
            [5147, 'Road Town', 241],
            [5148, 'Spanish Town', 241],
            [5149, 'Virgin Gorda', 241],
            [5150, 'Tortola', 241],
            [5151, 'Anegada', 241],
            [5152, 'Jost Van Dyke', 241],
            [5153, 'Charlotte Amalie', 242],
            [5154, 'Cruz Bay', 242],
            [5155, 'Saint Thomas', 242],
            [5156, 'Saint Croix', 242],
            [5157, 'Matā Utu', 243],
            [5158, 'Vaitupu', 243],
            [5159, 'Leava', 243],
            [5160, 'Mala e', 243],
            [5161, 'Laayoune', 244],
            [5162, 'Willemstad', 249],
            [5163, 'Philipsburg', 250],
            [5164, 'Lower Princes Quarter', 250]
        ];
